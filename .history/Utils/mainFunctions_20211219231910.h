...
void insertPerson(Person *people, int ) {
	system("cls");

	people = realloc(people, ( * sizeof(Person)));
	...
	inputString(people[ - 1].firstName, 50);

	printf("Sobrenome: ");
	inputString(people[ - 1].lastName, 50);

	printf("e-mail: ");
	inputString(people[ - 1].email, 50);
	...
	printf("Rua: ");
	inputString(people[ - 1].address.street, 50);

	printf("Numero: ");
	scanf("%d", &people[ - 1].address.number);
	fflush(stdin);

	printf("Complemento: ");
	inputString(people[ - 1].address.comp, 50);

	printf("Bairro: ");
	inputString(people[ - 1].address.district, 50);

	printf("CEP: ");
	scanf("%d", &people[ - 1].address.zipCode);
	fflush(stdin);

	printf("Cidade: ");
	inputString(people[ - 1].address.city, 50);

	printf("Estado: ");
	inputString(people[ - 1].address.state, 50);

	printf("Pais: ");
	inputString(people[ - 1].address.country, 50);
	...
	printf("DDD: ");
	scanf("%d", &people[ - 1].phone.ddd);

	printf("Numero: ");
	scanf("%d", &people[ - 1].phone.number);
	...
	printf("Dia: ");
	scanf("%d", &people[ - 1].birthday.day);

	printf("Mes: ");
	scanf("%d", &people[ - 1].birthday.month);

	printf("Ano: ");
	scanf("%d", &people[ - 1].birthday.year);
